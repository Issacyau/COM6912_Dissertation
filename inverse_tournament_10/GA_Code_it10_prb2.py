...
best_optimal_sol = [59312,61472,62130,59446,58951,60056,60414,61472,61885,58959,109109,
109841,108489,109383,110720,110256,109016,109037,109957,107038,149659,155940,149316,152130,
150353,150045,148607,149772,155075,154662]
...
num_test_prb_2,mknapcb2_data = load_file_1("mknapcb2.txt") ### loaded the first problem file
print(len(mknapcb2_data),len(best_optimal_sol))
...
sorted_index = sort_index(mknapcb2_data)
...
def inverse_tournament_selection(population,fitness): ### inverse tournament selection
    best = None
    for i in range(10):
...
for i in range(30):
    S_star,best_fitness,t = GA_MKP(250,100,mknapcb2_data["prb"+str(i)],sorted_index[i],best_optimal_sol[i])
