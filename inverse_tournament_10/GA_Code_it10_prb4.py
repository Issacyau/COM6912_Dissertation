...
best_optimal_sol = [23064,22801,22131,22772,22751,22777,21875,22635,22511,22702,41395,
42344,42401,45624,41884,42995,43559,42970,42212,41207,57375,58978,58391,61966,
60803,61437,56377,59391,60205,60633]
...
num_test_prb_4,mknapcb4_data = load_file_2("mknapcb4.txt") ### loaded the first problem file
print(len(mknapcb4_data),len(best_optimal_sol))
...
sorted_index = sort_index(mknapcb4_data)
...
for i in range(30):
    S_star,best_fitness,t = GA_MKP(100,100,mknapcb4_data["prb"+str(i)],sorted_index[i],best_optimal_sol[i])
