...
best_optimal_sol = [56693,58318,56553,56863,56629,57119,56292,56403,57442,56447,107689,108338,106385,106796,107396,107246,106308,103993,106835,105751,150083,149907,152993,153169,150287,148544,147471,152841,149568,149572]
...
num_test_prb_8,mknapcb8_data = load_file_3("mknapcb8.txt") ### loaded the first problem file
print(len(mknapcb8_data),len(best_optimal_sol))
...
sorted_index = sort_index(mknapcb8_data)
...
for i in range(30):
    S_star,best_fitness,t = GA_MKP(250,100,mknapcb8_data["prb"+str(i)],sorted_index[i],best_optimal_sol[i])
