...
best_optimal_sol = [117726,119139,119159,118802,116434,119454,119749,118288,117779,119125,217318,219022,217772,216802,213809,215013,217896,219949,214332,220833,304344,302332,302354,300743,304344,301730,304949,296437,301313,307014]
...
num_test_prb_6,mknapcb6_data = load_file_2("mknapcb6.txt") ### loaded the first problem file
print(len(mknapcb6_data),len(best_optimal_sol))
...
sorted_index = sort_index(mknapcb6_data)
...
for i in range(30):
    S_star,best_fitness,t = GA_MKP(500,100,mknapcb6_data["prb"+str(i)],sorted_index[i],best_optimal_sol[i])
